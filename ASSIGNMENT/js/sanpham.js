...
function themDemo() {
  ...
  let sp1 = new Product(
    ...
    "sp1.jpg",
    "SẢN PHẨM 1",
    "Chuột Có dây Gaming Asus TUF M3",
    550000
  ...
  let sp3 = new Product(
    ...
    "sp3.jpg",
    "SẢN PHẨM 3",
    "Bàn Phím Cơ Có Dây Gaming Rapoo V500alloy",
    390000
  ); // Tạo các đối tượng cho lớp Product
  let sp4 = new Product(
    4,
    "sp4.jpg",
    "SẢN PHẨM 4",
    "Bàn Phím Bluetook DareU EK 686",
    585000
  );
  let sp5 = new Product(
    5,
    "sp5.jpg",
    "SẢN PHẨM 5",
    "Tai nghe Bluetooth Chụp Tai JBL Tune 520BT ",
    1190000
  ); // Tạo các đối tượng cho lớp Product
  let sp6 = new Product(
    6,
  ...
  let sp7 = new Product(
    ...
    "sp7.jpg",
    "SẢN PHẨM 7",
    "Tay cầm không dây MSI Force GC30 V2",
    940000
  ); // Tạo các đối tượng cho lớp Product
  let sp8 = new Product(
    8,
    "sp8.jpg",
    "SẢN PHẨM 8",
    "Tai nghe Bluetooth Chụp Tai HAVIT H663BT ",
    485000
  );
